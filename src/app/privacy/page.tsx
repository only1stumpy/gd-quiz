export default function PrivacyPage() {
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to GDQuiz.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to GDQuiz, accessible from{" "}
            <a
              href="https://gd-quiz.vercel.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://gd-quiz.vercel.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: rei228322@gmail.com</li>
      </ul>
    </>
  );
}
